...
google_api_key = 'AIzaSyC1YndR2W_jayyrdmVeFQ7vUGbnZ_tohsU'
...
def findARestaurant(mealType, location):
    ...
    url = (
        'https://api.foursquare.com/v2/venues/search?client_id={}&client_secret={}&v=20130815&ll={},{}&query={}'.format(
    ...
    if result['response']['venues']:
        ...
        url = (
            'https://api.foursquare.com/v2/venues/{}/photos?client_id={}&v=20150603&client_secret={}'.format(
